...
void animate(void)
{
	if (play) {
		...
		if (estado == 0) {//------------------------------------------------- Estoy en A == 0
			
			if (reversa) {//Sigo en A
				rotKit_y = 180;
				if (movKit_z > -150) {
					movKit_z += -1.0f;
					//printf("%f \n", movKit_z);
				...
				if (movKit_z < 150) { //Sigo en estado A == 0
					movKit_z += 1.0f;
					//printf("%f \n", movKit_z);
				}
				else { //Transición a B
		...
		if (estado == 1) {// ----------------------------------------------------------------Sigo en B == 1

			if (reversa) {//Sigo en B
				rotKit_y = 180;
				if (movKit_z > -150) { //Estoy en B
					movKit_z += -1.0f;
					//printf("%f \n", movKit_z);
				}
				else { //Paso a A
		...
		if (estado == 2) { // --------------------------------------------------------------- Sigo en C == 2

			if (reversa) {//Sigo en C
				rotKit_y = 270;
				if (movKit_x > 0) {
					movKit_x += -1.0f;
					//printf("%f \n", movKit_x);
		...
		if (estado == 3) { // --------------------------------------------------------------- Sigo en D == 3

			if (reversa) {//Sigo en D
				rotKit_y = 0;
				if (movKit_z < 150) { //Sigo en estado D == 3
					movKit_z += 1.0f;
					//printf("%f \n", movKit_z);
				}
				else { //Transición a C
		...
		if (estado == 4) { // ------------------------------------------------------------- Estoy en E == 4
			
			if (reversa) {//Sigo en E
				rotKit_y = 90;
				if (movKit_x < 180) {
					movKit_x += 1.0f;
					//printf("%f \n", movKit_x);
