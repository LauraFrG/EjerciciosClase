...
void display(void)
{
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 0.7f, 0.4f));
	sphere_draw();
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.5f, 1.0f, 0.7f));
	sphere_draw();
	...
	model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.9f, 0.3f, 0.3f));
	sphere_draw();                                                                                                                                                                                                                                                                                                                                                                       
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.6f, 0.6f, 0.6f));
	sphere_draw();
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.85f, 0.85f, 0.85f));
	sphere_draw();
	...
	model = glm::scale(model, glm::vec3(0.04f, 0.04f, 0.04f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.95f, 0.95f, 0.95f));
	sphere_draw();
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.2f, 0.9f, 0.8f));
	sphere_draw();
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.5f, 0.5f, 0.85f));
	sphere_draw();

	model = temp01;

	//Anillo Saturno 2
	model = glm::rotate(model, glm::radians(saturno * 2), glm::vec3(1.0f, 0.1f, 0.0f));
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.7f, 0.7f, 0.9f));
	sphere_draw();
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.4f, 0.9f, 0.4f));
	sphere_draw();
