...
{	
	float vertices[] = {
		...
		-0.5, 0.5, 0.5,		0.25f, 0.66f, //1
		-0.5, -0.5, 0.5,	0.25f, 0.33f, //2
		0.5, -0.5, 0.5,		0.5f, 0.33f, //3 

		0.5, -0.5, -0.5,	0.75f, 0.33f, //4
		0.5, 0.5, -0.5,		0.75f, 0.66f, //5
		-0.5, 0.5, -0.5,	0.0f, 0.66f, //6
		-0.5, -0.5, -0.5,	0.0f, 0.33f, //7

		0.5, -0.5, -0.5,	0.5f, 0.0f, //4-8
		0.5, 0.5, -0.5,		0.5f, 1.0f, //5-9
		-0.5, 0.5, -0.5,	0.25f, 1.0f, //6-10
		-0.5, -0.5, -0.5,	0.25f, 0.0f //7-11
